...
public class LinkedListTest {
	public static void main(String[] args) {
		...
		System.out.println("Enter a '1' to add a node, a '2' to delete a node, a '3' to print the list from the head, or any other key to end the program.");
		...
		while(userInput == 1 || userInput == 2 || userInput == 3) {
			...
			System.out.println("Enter a '1' to add a node, a '2' to delete a node, a '3' to print the listfrom the head, or any other key to end the program.");
			userInput = in.nextInt();
		}
	}
}
